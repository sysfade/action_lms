...
import { createLesson, uploadFile } from '../api/lessons';
    ...
    <div className="dashboard-wrapper">
      ...
      <main className="dashboard-main">
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <h1 style={{ fontSize: '1.75rem', fontWeight: 700, marginBottom: '0.5rem' }}>Add New Lesson</h1>
          <p style={{ color: 'var(--color-text-muted)', marginBottom: '2rem' }}>Create educational content for your students.</p>
